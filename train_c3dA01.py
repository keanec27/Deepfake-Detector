...
def main():
    ...
    list_0 = [join(train_path[1], x) for x in listdir(train_path[1])] #real
    ...
    if not os.path.exists("/content/results01/"):
        os.mkdir("/content/results01/")
    plot_history(history, "/content/results01/")
    save_history(history, "/content/results01/")
    model.save_weights("/content/results01/" + args.weights_save_name + ".hdf5")
    model.save("/content/results01/" + args.model_name+'01'+ ".h5")
